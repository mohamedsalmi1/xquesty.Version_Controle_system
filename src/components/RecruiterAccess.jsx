...
function ModalBranding() {
  return (
    <div className="flex flex-col items-center justify-center pt-6 pb-2">
      ...
      />
      <span className="text-xl font-bold text-blue-900 tracking-tight mt-2"></span>
      <span className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto mb-6 sm:mb-8 px-2">You're not browsing. You're building.</span>
    </div>
  );
}
